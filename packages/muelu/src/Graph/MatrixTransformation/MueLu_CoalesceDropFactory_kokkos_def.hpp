      ...
      if (algo == "classical" || algo == "block diagonal classical") {
        ...
        if (algo == "block diagonal classical") {
          ...
          if (classicalAlgoStr == "default") {
            auto classical_dropping = ClassicalDropping::DropFunctor<Scalar, LocalOrdinal, GlobalOrdinal, Node, SoC>(*A, threshold, results);
            ...
            auto comparison = CutDrop::ScaledComparison<Scalar, LocalOrdinal, GlobalOrdinal, Node, SoC>(*A, results);
            auto cut_drop   = CutDrop::CutDropFunctor(comparison, threshold);
        ...
        auto signed_classical_rs_dropping = ClassicalDropping::DropFunctor<Scalar, LocalOrdinal, GlobalOrdinal, Node, SoC>(*A, threshold, results);
        ...
        if (classicalAlgoStr == "default") {
          auto signed_classical_sa_dropping = ClassicalDropping::DropFunctor<Scalar, LocalOrdinal, GlobalOrdinal, Node, SoC>(*A, threshold, results);
        ...
        if (algo == "block diagonal distance laplacian") {
          ...
          if (distanceLaplacianAlgoStr == "default") {
            auto dist_laplacian_dropping = DistanceLaplacian::DropFunctor<Scalar, LocalOrdinal, GlobalOrdinal, Node, decltype(dist2), SoC>(*A, threshold, dist2, results);
            ...
            auto comparison = CutDrop::ScaledDistanceLaplacianComparison<Scalar, LocalOrdinal, GlobalOrdinal, Node, decltype(dist2), SoC>(*A, dist2, results);
            auto cut_drop   = CutDrop::CutDropFunctor(comparison, threshold);
      ...
      if (algo == "classical") {
        ...
        if (distanceLaplacianAlgoStr == "default") {
          ...
          if (distanceLaplacianMetric == "unweighted") {
            ...
            auto dist_laplacian_dropping = DistanceLaplacian::VectorDropFunctor<Scalar, LocalOrdinal, GlobalOrdinal, Node, decltype(dist2), SoC>(*A, *mergedA, threshold, dist2, results, rowTranslation, colTranslation);
